...
<script type="text/javascript" src="parametros/js/tipo_reporte.js"></script>
<style>
...
<div class="row">
	<div class="col-md-12">
        <?php if($CREAR=="S"){ ?>
        <button type="button" id="btn_nuevo_tipo_reporte" style class="btn btn-green btn-icon icon-left">Nuevo<i class="entypo-plus"></i></button>
        <?php } 
        if($EDITAR=="S"){ ?>
        <button type="button" id="btn_editar_tipo_reporte" class="btn btn-orange btn-icon icon-left">Editar<i class="entypo-pencil"></i></button>
        <?php }  
        if($ELIMINAR=="S"){ ?>
        <button type="button" id="btn_eliminar_tipo_reporte" class="btn btn-red btn-icon icon-left">Eliminar<i class="entypo-trash"></i></button>
        <?php } ?>
    </div>
</div>
<br/>
...
<table id="tbl_tipo_reporte" class="table table-bordered datatable table-responsive">
    <thead>
        <tr> 
...
<div class="modal fade" id="frm-tipo-reporte">
		<div class="modal-dialog modal-sm">
			<div class="modal-content">				
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
					<h4 class="modal-title" id="frm-titulo-tipo-reporte">Titulo</h4>
				</div>
				
				<div class="modal-body">
                    <form id="form-tipo-reporte">
                        <input type="hidden" id="id_tipo_reporte" name="id_tipo_reporte" class="form-control clear" value="" />				
                        <div class="row">
                            <div class="col-md-12">							
