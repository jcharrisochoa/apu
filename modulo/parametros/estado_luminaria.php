...
<script type="text/javascript" src="parametros/js/estado_luminaria.js"></script>
<style>
...
<ol class="breadcrumb" >
    ...
    <li class="active">
    <strong>Listado Estado Luminaria</strong>
    </li>
</ol>
</hr>
<div class="row">
	<div class="col-md-12">
        <button type="button" id="btn_nuevo_estado_luminaria" style class="btn btn-green btn-icon icon-left">Nuevo<i class="entypo-plus"></i></button>
        <button type="button" id="btn_editar_estado_luminaria" class="btn btn-orange btn-icon icon-left">Editar<i class="entypo-pencil"></i></button>
        <button type="button" id="btn_eliminar_estado_luminaria" class="btn btn-red btn-icon icon-left">Eliminar<i class="entypo-trash"></i></button>
    </div>
</div>
<br/>
...
<table id="tbl_estado_luminaria" class="table table-bordered datatable table-responsive">
    <thead>
        <tr> 
...
<div class="modal fade" id="frm-estado-luminaria">
		<div class="modal-dialog modal-sm">
			<div class="modal-content">				
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
					<h4 class="modal-title" id="frm-titulo-estado-luminaria">Titulo</h4>
				</div>
				
				<div class="modal-body">
                    <form id="form-estado-luminaria">
                        <input type="hidden" id="id_estado_luminaria" name="id_estado_luminaria" class="form-control clear" value="" />				
                        <div class="row">
                            <div class="col-md-12">							
