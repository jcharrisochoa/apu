...
--
-- Dumping data for table `archivo_pqr`
--

LOCK TABLES `archivo_pqr` WRITE;
/*!40000 ALTER TABLE `archivo_pqr` DISABLE KEYS */;
/*!40000 ALTER TABLE `archivo_pqr` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2020-10-02 10:53:43
